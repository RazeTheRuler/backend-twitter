...
-export([split_transformer/0, decorate_with_id/1, twitter_producer/3, get_account_keys/1]).
...
split_loop(Sink, Sender, Buffer) -> case Buffer == <<"\r\n">> of
  false ->
  ...
  true -> twitterminer_riak:gather_tweets() end. 
